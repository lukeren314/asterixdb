...
public class ExternalAggregateFunctionInfo extends ExternalFunctionInfo {

    private static final long serialVersionUID = 3L;

    public ExternalAggregateFunctionInfo(FunctionIdentifier fid, List<IAType> parameterTypes, IAType returnType,
